...
public class XiaoyuanshiwuzhaolingLiuyanView extends XiaoyuanshiwuzhaolingLiuyanEntity implements Serializable {
	...
	public XiaoyuanshiwuzhaolingLiuyanView() {

	}

	public XiaoyuanshiwuzhaolingLiuyanView(XiaoyuanshiwuzhaolingLiuyanEntity xiaoyuanshiwuzhaolingLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xiaoyuanshiwuzhaolingLiuyanEntity);
